...
class HomeAdapter constructor(var documents: List<Document>, val context: Context) : RecyclerView.Adapter<HomeViewHolder>(), View.OnClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        ...
        holder = HomeViewHolder(view, context)
